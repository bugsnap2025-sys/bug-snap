...
export const IntegrationsHub: React.FC = () => {
    ...
    const isConnected = (source: IntegrationSource) => {
        switch (source) {
            ...
            case 'Microsoft': return !!config.microsoftToken;
        }
    };
        ...
        <div className="flex-1 bg-slate-50 dark:bg-[#0f0f0f] overflow-y-auto transition-colors">
            ...
            <div className="max-w-6xl mx-auto p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    {/* Microsoft Card */}
                    <div className="bg-white dark:bg-[#1e1e1e] rounded-2xl shadow-sm border border-slate-200 dark:border-[#272727] p-6 flex flex-col hover:border-blue-600 dark:hover:border-blue-600 transition-all group relative overflow-hidden">
                        ...
                        <div className="w-14 h-14 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/4/44/Microsoft_logo.svg" className="w-8 h-8" alt="Microsoft" />
                        </div>
                        <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Microsoft</h3>
                        <p className="text-slate-500 dark:text-zinc-400 text-sm mb-6 flex-1">
                            Connect your Microsoft account to access OneDrive and other services.
                        </p>
                        ...
                        {isConnected('Microsoft') ? (
                            ...
                            <button
                                ...
                                className="w-full py-2.5 rounded-lg font-bold text-sm transition-all flex items-center justify-center gap-2 bg-blue-600 text-white hover:bg-blue-700 shadow-md hover:shadow-lg"
                            >
                                Connect Microsoft <ArrowRight size={16} />
                            </button>
                        )}
                    </div>
